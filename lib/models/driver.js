...
class Driver {
   ...
   *
   * @namespace Drivers.fetchTotalSupply
   * @returns {number}
   ...
   *
   * @namespace Drivers.fetchCirculatingSupply
   * @returns {number}
   ...
   *
   * @namespace Drivers.fetchMaxSupply
   ...
   * Fetch the balance
   *
   * @namespace Drivers.fetchBalance
   ...
   *
   * @namespace Drivers.fetchAssetTotalSupply
   ...
   * Fetch asset balance
   *
   * @namespace Drivers.fetchAssetBalance
   * @returns {number}
