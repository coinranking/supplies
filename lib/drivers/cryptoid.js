...
class CryptoID extends Driver {
  ...
  async totalSupplyFastcoin() {
    const total = await this.request('https://chainz.cryptoid.info/fst/api.dws?q=totalcoins');
    return Number(total);
  }
  ...
  async totalSupplyKnoxFS() {
    const total = await this.request('https://chainz.cryptoid.info/kfx/api.dws?q=totalcoins');
    return Number(total);
  }
  ...
  async totalSupplyNewYorkCoin() {
    const total = await this.request('https://chainz.cryptoid.info/nyc/api.dws?q=totalcoins');
    return Number(total);
  }
  ...
  async circulatingSupplyFastcoin() {
    const total = await this.request('https://chainz.cryptoid.info/fst/api.dws?q=circulating');
    return Number(total);
  }
  ...
  async circulatingSupplyKnoxFS() {
    const total = await this.request('https://chainz.cryptoid.info/kfx/api.dws?q=circulating');
    return Number(total);
  }
  ...
  async circulatingSupplyNewYorkCoin() {
    const total = await this.request('https://chainz.cryptoid.info/nyc/api.dws?q=circulating');
    return Number(total);
  }
