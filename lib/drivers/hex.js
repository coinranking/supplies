...
class Hex extends Driver {
  ...
  async fetchCirculatingSupply() {
    const { originAddressHex, circulatingHex } = await this.request('https://hexvisionpublicapi.azurewebsites.net/api/OriginAddressInfo');
    const circulating = Number(circulatingHex) - Number(originAddressHex);
