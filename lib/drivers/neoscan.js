...
class NeoScan extends Driver {
   ...
   * @param {referenceModifier} modifier
   * @async
   */
  ...
  /**
   * @augments fetchAssetTotalSupply
   * @param {referenceParam} reference
   * @async
   */
  ...
  /**
   * @augments fetchAssetBalance
   * @param {referenceParam} reference
   * @param {modifierParam} modifier
   * @async
   */
